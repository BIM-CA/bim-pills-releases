<div align="center">
  ...
  <p>
    <a href="../../releases/latest"><img src="https://img.shields.io/badge/versi%C3%B3n-1.2.2-EF6337?style=for-the-badge" alt="Versión"/></a>
...
### 🔗 Conectar (Servidor IA)
Servidor MCP nativo que conecta Revit con cualquier cliente de IA compatible (Claude, Cursor, GitHub Copilot…). Permite exportar el modelo a JSON, validar documentos IDS y gestionar familias BIM-CA directamente desde el chat del asistente. Se instala automáticamente junto al plugin.
...
3. Ejecuta `BIMPills-1-2-2-Setup.exe` como administrador
