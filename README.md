<div align="center">
  ...
  <p>
    <a href="../../releases/latest"><img src="https://img.shields.io/badge/versi%C3%B3n-1.2.3-EF6337?style=for-the-badge" alt="Versión"/></a>
...
- **Importar desde el modelo** — Lee los esquemas de color (ColorFillScheme) del modelo abierto y los convierte en paletas reutilizables.
...
3. Ejecuta `BIMPills-1-3-0-Setup.exe` como administrador
